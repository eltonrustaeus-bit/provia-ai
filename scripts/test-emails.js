...
// Speglar MAIL_FROM i api/_site.js. Importeras INTE därifrån: det här skriptet körs som
// CommonJS (package.json saknar "type": "module"), och en statisk import av en ESM-modul
// skulle döda det — samma fel som tog ned /api/explain i produktion 2026-08-21.
//
// Variabeln heter RESEND_FROM, inte MAIL_DOMAIN. Skriptet skrevs mot ett tidigare utkast där
// avsändaren byggdes av en domändel; api/_site.js tar hela adressen ur RESEND_FROM i stället,
// så att den kan bytas i Vercel utan kodändring och utan deploy.
const FROM    = process.env.RESEND_FROM || "ExGen <noreply@proviaai.se>";
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="padding:12px 14px;background:#111a15;border-radius:5px 5px 0 0;border:1px solid rgba(27,255,140,.18);border-bottom:none">
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr><td colspan="2" style="padding-top:8px;font-size:13px;color:#a8c4b4;line-height:1.5">3 AI-mockprov/vecka &nbsp;·&nbsp; 5 P.E.R-frågor/vecka &nbsp;·&nbsp; inget kort krävs</td></tr>
              </table>
            </td></tr>
            <tr><td style="padding:12px 14px;background:#111a15;border:1px solid rgba(27,255,140,.12);border-bottom:none">
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr><td colspan="2" style="padding-top:8px;font-size:13px;color:#a8c4b4;line-height:1.5">30 AI-mockprov/mån &nbsp;·&nbsp; OCR från bilder &nbsp;·&nbsp; Historik &nbsp;·&nbsp; P.E.R 5/dag</td></tr>
              </table>
            </td></tr>
            <tr><td style="padding:12px 14px;background:#0e1c12;border-radius:0 0 5px 5px;border:1px solid rgba(27,255,140,.35)">
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr><td colspan="2" style="padding-top:8px;font-size:13px;color:#a8c4b4;line-height:1.5">Obegränsade prov &nbsp;·&nbsp; Felbank &nbsp;·&nbsp; P.E.R obegränsat</td></tr>
              </table>
            </td></tr>
          </table>
