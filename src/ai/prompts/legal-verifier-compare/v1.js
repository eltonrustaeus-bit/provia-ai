...
// kod inte kan avgöra deterministiskt. `generator_answer_matches` beräknas ÄNDÅ deterministiskt i
// api/knowledge.js (jämför independent_answer mot generatorns facit i kod, samma princip som
// hp.js:s `res[i].index === q.correct_index`) — modellens egen version av fältet skrivs över,
// litas inte på blint. Samma för `recommended_action`: modellens förslag är en signal, den
// FAKTISKA PASS/REPAIR/REJECT/MANUAL_REVIEW-logiken (§25.4) är deterministisk kod, se
