...
module.exports = async function handler(req, res) {
  ...
  const prompt = [
    ...
    "- För varje fråga: skriv en modellösning (vad som hade gett full poäng).",
    "- 3–8 tips.",
    "",
    "JSON-FORMAT:",
    '{ "level":"E"|"C"|"A", "total_points":number, "max_points":number, "per_question":[{"id":string,"points":number,"max_points":number,"feedback":string,"model_answer":string}], "tips":[string] }',
    "",
    `MÅLNIVÅ: ${safeLevel}`,
