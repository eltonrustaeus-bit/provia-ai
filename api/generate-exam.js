...
module.exports = async function handler(req, res) {
 ...
 // FIX: om DeepSeek returnerar tom sträng ska vi inte försöka JSON.parse(""), utan falla tillbaka
 if (!outputText) {
 return { ok: false, status: 500, error: "DeepSeek returned empty output" };
 }
