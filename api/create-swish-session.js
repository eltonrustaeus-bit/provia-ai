...
const SWISH_AMOUNTS = { basic: 2900, premium: 7900 }; // öre (SEK)
const PLAN_NAMES = {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!ok) {
      console.error("create-swish-session error:", JSON.stringify(session));
    ...
    console.error("create-swish-session error:", e?.message, e?.stack);
